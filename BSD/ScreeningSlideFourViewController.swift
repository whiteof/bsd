//
//  ScreeningSlideFourViewController.swift
//  BSD
//
...
class ScreeningSlideFourViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Get HTML Body
        fileLocation = NSBundle.mainBundle().pathForResource("screeningPage4", ofType: "html")!
        do {
        ...
        for j in 0...19 {
            for i in 0...49 {
                ...
                if j == 0 && i < 8 {
                    ...
                    image = "<img class=\"figure\" src=\"small_figure_active.png\" style=\"width: \(Int(figureWidth-1.0))px; height: \(Int(figureHeight))px;\">"
                }
                returnHtml += image
            }
            returnHtml += "<br />"
